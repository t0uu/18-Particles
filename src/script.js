...
// The WebGL currently draws pixels one on top of the other with the blending property, we can tell the WebGL to add the color of the pixel to the color of the pixel already drawn
vertexColors: true,
